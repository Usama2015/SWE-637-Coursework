...
public class Assignment2 {
	...
	public static String getModeList(String[] numbers) {
		...
		String mode = "";
		makeUniform(numbersCopy);
		modePopulateMap(numbersCopy, map);
	...
	private static String modeGetOrderedMode(String mode) {
		...
		makeUniform(arr);
		return (Arrays.toString(arr).replace("[", "").replace("]", "").replace(",", " ").replaceAll(" +", " "));
	}
	...
	public static void main(String[] args) {
		...
		switch (mode) {
			...
			case 3 -> System.out.println("The Mode is: " + getModeList(nums));
			case 4 -> {
